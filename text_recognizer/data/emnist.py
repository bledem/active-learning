...
technique = "margin"
PROCESSED_DATA_FILENAME =  SAMPLE_DATA_DIR / technique / 'merged_0.25_plus_uncertain_dataset.h5'
...
class EMNIST(BaseDataModule):
    ...
    # add by betty 325266 divided into 
    """

    def __init__(self, data_path, args=None, split_ratio=1):
        super().__init__(args)
    ...
    def setup(self, stage: str = None, split_train_val=None) -> None:
