...
def main():
    ...
    data_config = {'model': args.model_class,'sampling': technique,'data_path': args.data_path,'data_ratio': data.split_train_val_ratio,
    ...
    logger = WandbLogger() 
    wandb.run.name = f'{technique}_{data.split_train_val_ratio}_{args.model_class}'
